...
namespace Trade_GP.Dao.postgre
{
    class daoResumo5405
    {
        ...
        public Resumo_5405 Insert(Resumo_5405 obj)
        {
            ...
            String StringInsert = "INSERT INTO resumo_5405(id_grupo, cod_emp, local, material, descricao, unid, fator, dt_ref) " +
                                  "VALUES(@id_grupo, @cod_emp, @local, @material, @descricao, @unid, @fator, @dt_ref) RETURNING *";
        ...
        public void Update(Resumo_5405 obj)
        {
            String StringUpdate = "UPDATE resumo_5405 SET " +
                                  ...
                                  "unid = @unid, " +
                                  "fator = @fator " +
                                  "WHERE id_grupo = @id_grupo AND cod_emp = @cod_emp AND local = @local AND material = @material;";
        ...
        {
            String StringDelete = "DELETE FROM resumo_5405 WHERE id_grupo = @id_grupo AND cod_emp = @cod_emp AND local = @local AND material = @material AND dt_ref = @dt_ref;";
        ...
        public List<Resumo_5405_01> getAll(int id_grupo, string cod_emp, string local)
        {
            ...
            string query = $"SELECT material, descricao, unid, fator, dt_ref " +
                           "FROM resumo_5405 " +
        ...
        public string SqlGrid(int id_grupo, string cod_emp, string local, DateTime dt_ref)
        {
            ...
            string strSelect = "select  material, descricao , unid, fator, dt_ref from resumo_5405 ";
